    ...
    <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-black border border-black dark:border-gray-700 l p-8">
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center cursor-pointer select-none">
              <input type="checkbox" className="w-4 h-4 border-2 border-black dark:border-white bg-white dark:bg-black checked:bg-black dark:checked:bg-white accent-black dark:accent-white rounded-none cursor-pointer" />
              <span className="ml-2 text-xs font-bold text-black dark:text-white uppercase tracking-wider">Remember me</span>
            </label>
            <a href="#" className="text-xs font-bold text-black dark:text-white uppercase tracking-wider underline hover:no-underline">Forgot password?</a>
          </div>
        ...
        <div className="mt-6 text-center text-xs font-bold uppercase tracking-wider text-black dark:text-white">
          ...
          <Link href="/signup" className="underline hover:no-underline font-black text-black dark:text-white">
            Sign up
          </Link>
        </div>
      </div>
